...
<body>
    ...
    <div class="page-wrapper">
                    ...
                    <div class="main-nav__right">
                         <?php if(auth()->guard()->guest()): ?>
                            <li style="list-style:none" class="nav-item">
                                <a  class="main-nav__btn" href="<?php echo e(route('login')); ?>"><?php echo e(__('Login')); ?></a>
                            </li>
                            <?php if(Route::has('register')): ?>
                                <li style="list-style:none" class="nav-item">
                                    <a  class="main-nav__btn" href="<?php echo e(route('register')); ?>"><?php echo e(__('Register')); ?></a>
                                </li>
                            <?php endif; ?>
                        <?php else: ?>
                            ...
                            <a  class="main-nav__btn" href="<?php echo e(route('logout')); ?>"
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">
        ...
        </header><!-- /.site-header-one --><?php /**PATH C:\xampp\htdocs\web\resources\views/header1.blade.php ENDPATH**/ ?>